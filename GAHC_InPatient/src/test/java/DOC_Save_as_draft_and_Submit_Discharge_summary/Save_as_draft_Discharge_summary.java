...
package DOC_Save_as_draft_and_Submit_Discharge_summary;
...
public class Save_as_draft_Discharge_summary {
	...
	public void Physicians_Discharge_Summary_Edge(WebDriver driver) {
		...
		try {
			...
			Logger.getLogger(Save_as_draft_Discharge_summary.class.getName()).log(Level.SEVERE, null, ex);
		}
