...
public class Verify_Transfer_Stock_Across_Facilities {
	...
	public void transfer_stock(WebDriver driver) {
		...
		try {
			...
			Thread.sleep(500);
			WebElement DispenseMed = driver.findElement(By.id("jd35"));  //By.id("jd37")
			DispenseMed.click();
			Thread.sleep(500);
			WebElement Issue = driver.findElement(By.id("jd41"));  //By.id("jd43")
			Issue.click();
			Thread.sleep(500);
			WebElement Create_ReviewReq = driver.findElement(By.id("sd43"));  //By.id("sd45")
			...
			for (String window1 : windows1) {
				...
				if (driver.getTitle().contains("Modify Document Details")) {
					...
					Thread.sleep(500);
					WebElement Authorize = driver.findElement(By.id("sd45"));  //By.id("sd47")
					Authorize.click();
					Thread.sleep(2000);
				}
			}
			...
			for (String window1w : windows1w) {
				...
				if (driver.getTitle().contains("Documents for Authorize")) {
					...
					Thread.sleep(500);
					WebElement Issue2 = driver.findElement(By.id("sd46"));  //By.id("sd48")
					Issue2.click();
					Thread.sleep(2000);
					...
					Thread.sleep(1000);
					WebElement Acknowledge = driver.findElement(By.id("jd66"));  //By.id("sd66")
					Acknowledge.click();
					Thread.sleep(500);
					WebElement AcknowledgeBTN = driver.findElement(By.id("sd67"));  //By.id("sd69")
