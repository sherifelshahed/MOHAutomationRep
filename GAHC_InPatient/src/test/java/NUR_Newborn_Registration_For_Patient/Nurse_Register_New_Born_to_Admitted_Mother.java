...
public class Nurse_Register_New_Born_to_Admitted_Mother {
	...
	public void newborn_registration(WebDriver driver) {
		...
		try {
			...
			PatientIDTXT.sendKeys("A200000587");
				...
				for (String window2 : windowsx) {
					...
					if (driver.getTitle().contains("Register New Born")) {
						...
						WebElement Activity = driver
								.findElement(By.xpath("//div/div[2]/table/tbody[2]/tr/td[2]/select"));
						Activity.click();
						...
						WebElement Pulse = driver
								.findElement(By.xpath("//div/div[2]/table/tbody[2]/tr[2]/td[2]/select"));
						Pulse.click();
						...
						WebElement Grimace = driver
								.findElement(By.xpath("//div/div[2]/table/tbody[2]/tr[3]/td[2]/select"));
						Grimace.click();
