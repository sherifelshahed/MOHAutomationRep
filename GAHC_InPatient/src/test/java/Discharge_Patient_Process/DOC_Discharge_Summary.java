...
public class DOC_Discharge_Summary {

	public void Physicians_Discharge_Summary_Edge(WebDriver driver, String Patient_ID) {
		...
		try {
			...
			driver.findElement(searchFormText).sendKeys("Discharge Summary" + Keys.ENTER);
			...
			Logger.getLogger(DOC_Discharge_Summary.class.getName()).log(Level.SEVERE, null, ex);
		}
