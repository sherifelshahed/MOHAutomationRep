...
public class Nurse_Check_Block_Bed_with_all_data_required {
	public void bed(WebDriver driver) {
		...
		InterruptedException ex) {
			Logger.getLogger(Nurse_Check_Block_Bed_with_all_data_required.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}