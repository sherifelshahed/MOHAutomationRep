...
public class Save_as_draft_Place_Order {
	...
	public void Physicians_order_Edge(WebDriver driver) {
		...
		try {
			...
			By Select_facility = By.xpath(
					"/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-consultation-note/div/div/div[1]/div[2]/app-consultation-note-section/div/div/div[2]/div/div[2]/div[2]/div/div[2]/input");
			driver.findElement(Select_facility).click();
			Thread.sleep(1000);
			
			By Selected_facility = By.xpath(
					"/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-consultation-note/div/div/div[1]/div[2]/app-consultation-note-section/div/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div[1]");
			driver.findElement(Selected_facility).click();
