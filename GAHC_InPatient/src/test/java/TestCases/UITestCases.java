		...
		btnNewButton.addActionListener(new ActionListener() {	
			...
			public void actionPerformed(ActionEvent e) {
				if (rdbtnNewRadioButton_6.isSelected()) {
					...
					TestListenerAdapter tla = new TestListenerAdapter();
					TestNG testng = new TestNG();
					testng.setTestClasses(new Class[] { IP_TC_053_054_055_056_059_061_070_071_073_074_077_079_081_083_093_094_095_098_099_100_102_110_119_122_127_129.class });
					testng.addListener(tla);
					testng.run();
					...
					TestListenerAdapter tla = new TestListenerAdapter();
					TestNG testng = new TestNG();
					testng.setTestClasses(new Class[] { IP_TC_707_IP_TC_742.class });
					testng.addListener(tla);
					testng.run();
					...
					TestListenerAdapter tla = new TestListenerAdapter();
					TestNG testng = new TestNG();
					testng.setTestClasses(new Class[] { GroupA.class });
					testng.addListener(tla);
					testng.run();
				}else if(rdbtnNewRadioButton_82.isSelected()) {
					TestListenerAdapter tla = new TestListenerAdapter();
					TestNG testng = new TestNG();
					testng.setTestClasses(new Class[] { GroupB.class });
					testng.addListener(tla);
					testng.run();
					...
					TestListenerAdapter tla = new TestListenerAdapter();
					TestNG testng = new TestNG();
					testng.setTestClasses(new Class[] { GroupHP.class });
					testng.addListener(tla);
					testng.run();
