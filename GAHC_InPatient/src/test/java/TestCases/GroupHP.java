...
import DOC_Change_Password.Change_Password;
import DOC_Change_Password.Login1_HP;
import DOC_Change_Password.Login2_HP;
import DOC_Change_Password.Logout_HP;
import DOC_Change_Password.Rechange_Password;
import DOC_Discharge_Summary.Discharge_Summary;
import DOC_IPD_OPConsultation.OP_consultation_form;
import DOC_IPD_Refer_to_Admission.Refer_to_Admission;
import DOC_Initiate_discharge.Initiate_discharge;
import DOC_Operation_Note.operation_note;
import DOC_Pages.*;
import DOC_Place_Lab_Order.*;
import DOC_Place_Order.Place_Order;
import DOC_Place_Rad_Order.SelectForm;
import DOC_Place_panel_order.Place_panel_order;
import DOC_Prescribe_Medications.Prescribe_Medications;
import DOC_Progress_Notes.Progress_Notes;
import DOC_Save_as_draft_and_Submit_Discharge_summary.Save_as_draft_Discharge_summary;
import DOC_Save_as_draft_and_Submit_Progress_Notes.Save_as_draft_Progress_Notes;
import DOC_Save_as_draft_and_Submit_Progress_Notes.Submit_after_save_as_draft;
import DOC_Save_as_draft_and_Submit_operation_note.Save_as_draft_operation_note;
